...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Book a Free Consultation | MJN Health',
    description:
      'Free 30-minute consultation with an assigned MJN Health consultant. We map your licensing pathway, timeline, and costs — no obligation.',
