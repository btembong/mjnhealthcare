...
const articles: Record<string, Article> = {
  ...
  'nurses-week-2025-ceo-message': {
    ...
    date: 'May 12, 2025',
    readTime: '3 min',
    excerpt: 'A personal message from John Nyah Mbout, BSN, RN — CEO and Founder of MJN Healthcare — honouring nurses everywhere on National Nurses Week 2025.',
    author: { name: 'John Nyah Mbout, BSN, RN', role: 'CEO & Founder, MJN Healthcare' },
    blocks: [
      { type: 'p', text: 'Dear Nurses,' },
      { type: 'p', text: 'As we celebrate National Nurses Week, I want to take this moment to extend my deepest gratitude to each one of you. At MJN Health Academy and Professional Services Ltd, we recognise that nurses are the heartbeat of healthcare. Your dedication, compassion, and resilience are what keep the system moving forward — especially in times of great challenge.' },
