...
export const members: TeamMember[] = [
  ...
  },
  {
    ...
    expertise: ['Staffing Coordination', 'Candidate Placement', 'Employer Onboarding', 'Pipeline Management'],
  ...
  },
  {
    ...
    expertise: ['Exam Prep Coordination', 'Study Programme Management', 'Academy Operations', 'Candidate Support'],
