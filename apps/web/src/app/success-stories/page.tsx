...
const stories = [
  ...
  },
  {
    ...
    from: 'Cameroon',
    to: 'Dubai, UAE',
    pathway: 'DHA Licensing + Job Placement',
    duration: 'Full-service from Cameroon to placement',
    outcome: 'DHA Staff Nurse, Dubai — DataFlow managed from Cameroon, welcomed on arrival, CV prepared',
