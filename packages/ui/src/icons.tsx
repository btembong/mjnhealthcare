...
export const FirstAid             = makeIcon('solar:medical-kit-bold', 'solar:medical-kit-bold-duotone');
...
export const Headphones           = makeIcon('solar:headphones-round-bold', 'solar:headphones-round-bold-duotone');
...
export const FirstAidKit          = makeIcon('solar:medical-kit-bold', 'solar:medical-kit-bold-duotone');
export const Headset              = makeIcon('solar:headphones-round-bold', 'solar:headphones-round-bold-duotone');
export const Handshake            = makeIcon('solar:hand-shake-bold', 'solar:hand-shake-bold-duotone');
...
export const Gavel                = makeIcon('solar:sledgehammer-bold', 'solar:sledgehammer-bold-duotone');
...
// ── Further aliases ───────────────────────────────────────────────────────────
export const Key                  = makeIcon('solar:key-bold', 'solar:key-bold-duotone');
export const ClockIcon            = makeIcon('solar:clock-circle-bold', 'solar:clock-circle-bold-duotone');
export const Flame                = makeIcon('solar:fire-bold', 'solar:fire-bold-duotone');
export const ImageIcon            = makeIcon('solar:gallery-bold', 'solar:gallery-bold-duotone');
export const Square               = makeIcon('solar:square-bold');
export const Video                = makeIcon('solar:camera-video-bold', 'solar:camera-video-bold-duotone');
export const VideoConference      = makeIcon('solar:camera-video-bold', 'solar:camera-video-bold-duotone');
export const Chat                 = makeIcon('solar:chat-round-bold', 'solar:chat-round-bold-duotone');
export const Circle               = makeIcon('solar:circle-bold');
export const FileDoc              = makeIcon('solar:document-text-bold', 'solar:document-text-bold-duotone');
export const LinkIcon             = makeIcon('solar:link-bold');
